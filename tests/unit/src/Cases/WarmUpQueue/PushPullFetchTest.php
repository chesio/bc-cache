...
class PushPullFetchTest extends \BlueChip\Cache\Tests\Unit\TestCase
{
    public function testWarmUpQueue()
    {
        ...
        $this->assertSame(0, $queue->getWaitingCount());
